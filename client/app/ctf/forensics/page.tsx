      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-gray-400 mt-3 max-w-2xl">
            PCAPs, memory images, logs, stego, artifact hunting. Articles coming soon.
          </p>
        </motion.div>
        ...
        >
          <div className="glass-effect p-10 rounded-lg cyber-border text-center">
            ...
            <h2 className="text-2xl font-semibold mb-2">Forensics writeups coming soon</h2>
            <p className="text-gray-400 mb-6">
              Case studies on PCAP analysis, memory forensics, and artifact extraction.
            </p>
            <div className="flex flex-wrap justify-center gap-2">
              {['PCAP', 'Wireshark', 'Volatility', 'Carving', 'Stego', 'Logs'].map(tag => (

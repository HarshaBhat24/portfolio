...
export default function OsintCTFPage() {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h1 className="text-4xl md:text-5xl font-bold">
            <span className="gradient-text">OSINT Writeups</span>
          </h1>
        ...
        >
          <div className="glass-effect p-10 rounded-lg cyber-border text-center">
            ...
            <h2 className="text-2xl font-semibold mb-2">OSINT writeups coming soon</h2>
            <p className="text-gray-400 mb-6">
              Techniques, workflows, and useful tools for open-source intelligence.
            </p>
